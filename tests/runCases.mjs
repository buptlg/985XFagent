...
const cases = [
  { persona: '河南理科650,纠结哈工大尖班 vs 南大计算机', q: '我河南理科650,冲哈工大尖班还是稳南大计算机?', modes: ['985', 'xf'] },
  { persona: '山东580,想学计算机', q: '山东580分,这个分能上什么档次的计算机?AI时代计算机还值得学吗?', modes: ['985', 'xf'] },
  { persona: '620纠结要不要学临床', q: '2024年了,620分还要不要报临床医学?家里想让我学医', modes: ['985', 'xf'] },
  { persona: '同济大类值不值', q: '冲同济的大类招生值不值?听说大一分流很卷', modes: ['985', 'xf'] },
  { persona: '文科生金融还是法学', q: '文科生,金融和法学怎么选?', modes: ['xf', '985'] },
]
