...
## 模式
- **985吧·实时锐评** —— 真实金句卡片流,按主题筛选:`专业鄙视链 / 院校battle / 排行榜 / 就业出口 / 升学保研 / 出国留学 / 科研读博 / 杂七杂八榜 / 分数线跳水 / 招生套路 / 后悔实录 / 元·张雪峰`。含**招生风格图鉴**(超短裙 / 姜-泰勒 / 共轭 + 2026今年新动向)、**黑话解码**、**🎲 随机斗一只蛐蛐**;部分卡片嵌 **9吧原图**(榜单/录用名单)和可折叠的 **🦗 楼中对线**。
- **赛博斗蛐蛐** —— 对话 agent,4 人设可切换:`985吧·斗蛐蛐 / 张雪峰·致敬 / 张雪峰·扮演 / 融合`。
